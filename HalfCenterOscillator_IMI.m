...
function x = HalfCenterOscillator_IMI()
...
channels = {'hill/CaF','hill/CaS','hill/HCurrent','hill/KACurrent','prinz/KCa',...
    'hill/KCurrent1','hill/KCurrent2','amarillo/Kir','Leak','swensen/MICurrent','hill/NaP','hill/NaV'};
...
% configure gbars
gCaF=5; gCaS=3.2; gH=4; gKA=80; gK1=100; gK2=80; gKCa=100; gKir=100; gMI=0; gNaP=5; gNaV=200; gL=8; % nS
gbar=[gCaF, gCaS, gH, gKA, gKCa, gK1, gK2, gKir, gL, gMI, gNaP, gNaV];
...
ECaF=135; ECaS=135; EH=-21; EKA=-70; EKCa=-70; EK1=-70; EK2=-70; EKir=-70; ENaP=45; ENaV=45; EL=-60; EMI=0; % mV
E=[ECaF, ECaS, EH, EKA, EKCa, EK1, EK2, EKir, EL, EMI, ENaP, ENaV];
...
%Vth=-47.5; % synaptic threshold (mV) for mixed
